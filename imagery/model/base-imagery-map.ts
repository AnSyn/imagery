...
export abstract class BaseImageryMap<T = any> {
	...
	public positionChanged: EventEmitter<IImageryMapPosition> =
		new EventEmitter<IImageryMapPosition>();
	public mousePointerMoved: EventEmitter<IMousePointerMove> =
		new EventEmitter<IMousePointerMove>();
	public mouseSingleClick: EventEmitter<IMouseClick> =
		new EventEmitter<IMouseClick>();
	public mouseRightClick: EventEmitter<IMouseClick> =
		new EventEmitter<IMouseClick>();
	public mouseDoubleClick: EventEmitter<IMouseClick> =
		new EventEmitter<IMouseClick>();
	public moveStart: EventEmitter<IImageryMapPosition> =
		new EventEmitter<IImageryMapPosition>();
	public mapLayerChangedEventEmitter: EventEmitter<any> =
		new EventEmitter<any>();

	public tilesLoadProgressEventEmitter: EventEmitter<IMapProgress> =
		new EventEmitter<IMapProgress>();
	public tilesLoadErrorEventEmitter: EventEmitter<IMapErrorMessage> =
		new EventEmitter<IMapErrorMessage>();

	protected _mapObject: T;
	get mapObject() {
	...
	abstract initMap(
		...
		mapViewContainerRef?: ViewContainerRef
	): Observable<boolean>;
	...
	abstract getCoordinateFromScreenPixel(screenPixel: {
		x;
		y;
